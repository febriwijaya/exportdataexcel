...
function tambah($data)
{
  ...
  // query insert data
  $query = "INSERT INTO data2019 VALUES ('', '$date', '$ot', '$m', '$Depth', '$Latitude', '$Longitude', '$lokasi', '$keterangan', '$intensitas')";
...
{
  global $conn;
  mysqli_query($conn, "DELETE FROM data2019 WHERE id = $id");
  return mysqli_affected_rows($conn);
}
