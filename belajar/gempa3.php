...
$gempa3 = query("SELECT * FROM data2020");
                      ...
                      <tbody>
                        ...
                        <?php foreach ($gempa3 as $row) : ?>
                          <tr>
                            ...
                            <td>
                              <a href="ubah3?id=<?php echo $row["id"]; ?>" class="badge badge-warning">ubah</a>
                              <a href="hapus3?id=<?php echo $row["id"]; ?>" onclick="return confirm('yakin?');" class="badge badge-danger">hapus</a>
                            </td>
                          </tr>
                          <?php $i++; ?>
                        <?php endforeach; ?>
